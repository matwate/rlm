LUA_MISTAKES = """## Common Lua Mistakes (AVOID THESE)
...
SYNTAX_REFERENCE = """## Lua Syntax Reference (MANDATORY - NO PYTHON SYNTAX)
...
REPL_ENVIRONMENT = """## REPL-like Environment
